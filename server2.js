...
function request( seats_left , requests , index , name , url) {
    console.log(url);
    ...
    mongoClient.connect('mongodb://localhost:27017/notice' , (err , db)=>{
        if(err) throw  err;
        var thisNotification = {name : name , price  :best_price , url : url , date: new Date()}
        var collection = db.collection("notification");
        collection.insertOne(thisNotification , (err , result)=>{
            if(err) throw err;
...
app.use('/enquiry' , (req , res)=>{
    ...
    if(hall == 0){
        if(movie == 0){
            ...
            index = 0;
            name = "Dear Zindagi";
            url = "https://in.bmscdn.com/iedb/movies/images/mobile/listing/large/dear-zindagi-et00044213-04-10-2016-03-12-36.jpg";
        ...
        if(movie == 1){
            ...
            index = 1;
            name = "Force 2";
            url = "https://in.bmscdn.com/iedb/movies/images/mobile/listing/large/force-2-et00035930-28-09-2016-12-53-10.jpg";
        ...
        if(movie == 2){
            ...
            url = "https://in.bmscdn.com/iedb/movies/images/mobile/listing/large/ae-dil-hai-mushkil-et00032168-30-08-2016-10-50-16.jpg";
        ...
        if(movie == 3){
            ...
            index = 3;
            name = "Rock On 2";
            url = "https://images.bewakoof.com/utter/banner-rock-on-2-teaser-out-why-we-love-it-and-why-we-don-t-1473160450.jpg"
    ...
    request ( left , requests , index , name , url);
    ////////////////////////////////
